...
if nom_count_dict == correct_result1:
    ...
    print(
        "Make sure you are referencing the correct lists for input to create the dictionary."
    )
...
for director, count in win_count_dict.items():
    if count > max_number:
        max_number = count
        max_win_director = director

most_win_director.append(max_win_director)

### Notebook grading
correct_ans = ["John Ford"]

if most_win_director == correct_ans:
    print("Good job!")
else:
    print(
        "Oops! That doesn't look like the expected answer. Make sure you are referencing the correct lists for input to create the list."
    )
