...
# calculate_commission() a method to calculate the salesperson commission based
# on total sales and a percentage
...
class SalesPerson:
    ...
    ### __init__ function to initialize the attributes
