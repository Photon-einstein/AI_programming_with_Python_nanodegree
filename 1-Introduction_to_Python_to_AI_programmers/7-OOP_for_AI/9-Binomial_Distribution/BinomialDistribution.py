...
class Binomial(Distribution):
    ...
    def __init__(self, prob : float = 0.5, size : int = 20 ):
    ...
    def replace_stats_with_data(self):
        ...
        #  file. Because the GeneralDistribution class inherits from the GeneralDistribution class,
        ...
        file_name = "numbers_binomial.txt"
    ...
    def plot_bar(self):
        ...
        count_zeros = sum(1 for el in self.data_list if el == 0)
        count_ones = sum(1 for el in self.data_list if el == 1)
...
if __name__ == "__main__":
    ...
    binomial.plot_bar()
    print("Plot bar pdf: ", binomial.plot_bar_pdf())
