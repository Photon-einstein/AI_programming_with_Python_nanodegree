...
# Calculate the total sales for the week from the data provided. Assign the result to a string variable with the
# form "This week's total sales: xxx", where xxx will be the actual total of all the numbers.
...
if result_string == "This week's total loss: 0.78":
    ...
    print(
        "That doesn't match the solution. The total loss should be 0.78. If that's what you got, check that your string is formatted correctly."
    )
