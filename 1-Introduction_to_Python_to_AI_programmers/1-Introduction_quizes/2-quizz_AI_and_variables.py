...
# Scenario:
# You are working with an AI model and need to adjust various parameters and metrics during the training process.
# Use the assignment operators to modify these values based on the given instructions.

# Task:
# Follow the instructions in the comments to modify the variables. After each comment, write a line of code that
...
if learning_rate == 0.01 * 0.9:
    ...
    print(
        "Sorry! learning_rate is too high. It looks like you increased the learning rate by 10% instead of decreasing it. Try again"
    )
else:
    print(
        "Sorry! learning_rate is incorrect. Try again and make sure to use the *= assignment operator"
    )
...
if training_loss == 0.8 + 0.02:
    ...
    print(
        "Sorry! training_loss is incorrect. Try again and make sure to use the += assignment operator"
    )
...
if training_loss == (0.8 + 0.02) * 1.05 * 0.95:
    ...
    print(
        "Sorry! training_loss is too high. Did you account for regularization? Try again"
    )
else:
    print(
        "Sorry! training_loss is incorrect. Try again and make sure to use the *= assignment operator"
...
if training_loss == (0.8 + 0.02) * 1.05 * 0.95 - 0.05:
    ...
    print(
        "Sorry! training_loss is too high. Did you account for the improved generalization? Try again"
    )
else:
    print(
        "Sorry! training_loss is incorrect. Try again and make sure to use the -= assignment operator"
