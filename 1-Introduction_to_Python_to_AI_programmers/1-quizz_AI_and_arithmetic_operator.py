...
# Scenario:
# You are working on a project where you need to analyze the average prediction accuracy of
# a machine learning model over the last three months. The accuracy scores for the last three months are 85.5%, 90.2%, and 87.3%.
...
print(f"\nTotal storage needed: {total_storage_mb:.2f} MB")
