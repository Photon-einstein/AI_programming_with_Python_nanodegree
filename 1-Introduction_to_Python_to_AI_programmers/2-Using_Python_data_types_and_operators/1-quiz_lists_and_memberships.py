...
# In this exercise, you'll use list indexing to determine the height of an image based
# on the integer variable image_index, and store that value in the integer variable image_height.
...
if last_three_filenames != correct_answer:
    print(
        "Double check your slicing! Your code should print a list of the last three filenames from the original list, and nothing else."
    )
else:
    print(
...
# In this exercise, you'll use list slicing to determine if a sequence of image classifications forms a palindrome.
...
if is_palindrome != correct_answer:
    print(
        "Not quite! Remember to use list slicing to reverse the list and check if it matches the original list."
    )
else:
    print(
