...
def scatterplot_solution_1():
    ...
    """
    sol_string = [
        "\nMost of the data falls in a large blob between 10 and 30 mpg city",
    ...
    plt.title("Solution City vs Highway consumption (mgp)")
    plt.show()
...
def scatterplot_solution_2():
    ...
    """
    sol_string = [
        "\nIn the heat map, I've set up a color map that goes from light",
    ...
    plt.ylabel("CO2 (g/mi)")
    plt.title("Solution Displacement vs CO2")
    plt.show()
...
def violinbox_solution_1():
    ...
    """
    sol_string = [
        "\nI used a violin plot to depict the data in this case; you might",
    ...
    plt.title("Solution Violin plot: Vehicle class vs Engine size")
    plt.show()
...
def categorical_solution_1():
    ...
    """
    sol_string = [
        "\nI chose a clustered bar chart instead of a heat map in this case",
...
def additionalplot_solution_1():
    ...
    """
    sol_string = [
        "\nDue to the large number of manufacturers to plot, I've gone",
...
def additionalplot_solution_2():
    ...
    """
    sol_string = [
        "\nSeaborn's barplot function makes short work of this exercise.",
