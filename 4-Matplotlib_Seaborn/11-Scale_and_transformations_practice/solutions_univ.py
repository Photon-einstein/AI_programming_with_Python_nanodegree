...
def bar_chart_solution_1():
    ...
    """
    sol_string = ["\nI used seaborn's countplot function to generate this chart.",
...
def bar_chart_solution_2():
    ...
    """
    sol_string = ["\nI created a horizontal bar chart since there are a lot of",
...
def histogram_solution_1():
    ...
    """
    sol_string = ["\nI've used matplotlib's hist function to plot the data.",
...
def scales_solution_1():
    ...
    """
    sol_string = ["\nThere's a very long tail of Pokemon heights. Here, I've",
...
def scales_solution_2():
    ...
    """
    sol_string = ["\nSince Pokemon weights are so skewed, I used a log transformation",
